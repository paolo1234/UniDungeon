...
public class BossBattleController extends BattleController {
  ...
  public int selectPlayerAction() {
    ...
    long currentTime;
    long lastTime = System.nanoTime();
    while ((gameStateMachine.getGameState() == GameState.BOSSBATTLE)
  ...
  public boolean battle() {
    ...
    if (enemiesAlive) return false; // Lose
    else return true; // Win
  }
  ...
  public boolean executeQuestion(int questionTurn) {
    ...
    AnswerIterator answerIterator =
        new AnswerIterator(
            game.getPlayers(), ((Boss) mobs[0]).getQuestions()[questionTurn].getAnswers());
