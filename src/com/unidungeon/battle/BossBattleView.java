...
public class BossBattleView extends BattleView {
    ...
    public BossBattleView(BattleController mediator){
        ...
        try {
            ...
            sfondo = ImageIO.read(Objects.requireNonNull(getClass().getResource("/battleIcons/bossbattle.png")));
            domanda = ImageIO.read(Objects.requireNonNull(getClass().getResource("/battleIcons/domanda.png")));
            risposte = ImageIO.read(Objects.requireNonNull(getClass().getResource("/battleIcons/quadranterisposte.png")));
            ...
            //font = Font.createFont(Font.TRUETYPE_FONT, Objects.requireNonNull(getClass().getResourceAsStream("/fonts/AGOBLINAPPEARS.ttf"))).deriveFont(12f);
        ...
        if(viewReady){
            ...
            switch (this.battleState){
                ...
                case ACTION_SELECTION -> {
                    ...
                    if(playerIcons != null) {
                        drawPlayerRect(g2, playerIcons[0], playerName[0], 20, currPlayerHP[0], maxPlayerHP[0], currPlayerSP[0], maxPlayerSP[0], playerLv[0]);
                        drawPlayerRect(g2, playerIcons[1], playerName[1], 163, currPlayerHP[1], maxPlayerHP[1], currPlayerSP[1], maxPlayerSP[1], playerLv[1]);
                        drawPlayerRect(g2, playerIcons[2], playerName[2], 306, currPlayerHP[2], maxPlayerHP[2], currPlayerSP[2], maxPlayerSP[2], playerLv[2]);
                    }
                ...
                case SKILL_SELECTION -> {
                    ...
                    if(skillNames != null)
                        drawSkillSelection(g2);
                    if(target >= 0)
                        drawEnemyTarget(g2, numberOfEnemies);
                }
                case ITEM_SELECTION -> {
                    if(mobName != null){
                        numberOfEnemies = mobName.length;
    ...
    void drawSkillSelection(Graphics2D g2){
        ...
        switch (currentAction){
            ...
            drawButton(g2, (skillNames[0]!= null) ? skillNames[0] +" (" +skillSP[0] + " sp)": "Vuoto",474, 373, 250, 32, attaccaSelected);
            drawButton(g2, (skillNames[1]!= null) ? skillNames[1] +" (" +skillSP[1] + " sp)": "Vuoto",474, 417, 250, 32, guardiaSelected);
            drawButton(g2, (skillNames[2]!= null) ? skillNames[2] +" (" +skillSP[2] + " sp)": "Vuoto",474, 461, 250, 32, itemSelected);
            drawButton(g2, (skillNames[3]!= null) ? skillNames[3] +" (" +skillSP[3] + " sp)": "Vuoto",474, 505, 250, 32, fuggiSelected);
    ...
    void drawButton(Graphics2D g, String buttonText, int x, int y, int width, int height, boolean active){
        if (active){
    ...
    void drawPlayerRect(Graphics2D g2, BufferedImage image, String nome, int xOffset, String currHP, String maxHP, String currSP, String maxSP, String liv){
        ...
        GradientPaint gp5 = new GradientPaint(x2, 505, new Color(0xCC4115), x2 + width, 505 + 28, new Color(0xE01182));
        // Crea il gradiente per rect6
        GradientPaint gp6 = new GradientPaint(x2, 533, new Color(0x4141D2), x2 + width, 533 + 28, new Color(0x0089DE));
    ...
    //Selecting action
    @Override
    public boolean selectActionView(Player[] player, Mobs[] mobs, int[] choice, Skill[] chosenSkill, int[] target){
