...
public class Player extends Entity {
    ...
    final private int THRESHOLD_LV = 50;    //Levelling up thershold increments
    final private int MAX_LV = 30;         //Max level reachable
    final private int HP_LV = 10;
    final private int SP_LV = 2;

    public Player(String name, Role role, Skill[] slot_skill, int maxHp, int maxSp, int currHp, int currSp, int lv, int exp, float dmg, float def, int prob_crit, int status, String iconPath){
        this.name = name;
        this.role = role;
    ...
    public void increaseSp(int sp){
        ...
        if(this.currSp>this.maxSp)
            this.currSp=this.maxSp;
    }
