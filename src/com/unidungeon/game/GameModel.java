...
public class GameModel  implements Serializable{
    ...
    private void initGame(){
        ...
        players[0] =
                new PlayerBuilder()
                        ...
                        .setDef(3)
                        .setProbCrit(30)
                        .setSkillSlot(new Skill[]{skillsList.get(0), skillsList.get(1), skillsList.get(2), skillsList.get(3)})
                        .build();
        ...
        players[1] =
                new PlayerBuilder()
                        ...
                        .setDef(2)
                        .setProbCrit(15)
                        .setSkillSlot(new Skill[]{skillsList.get(4), skillsList.get(5), skillsList.get(6), skillsList.get(7)})
                        .build();
        ...
        players[2] =
                new PlayerBuilder()
                        ...
                        .setDef(3)
                        .setProbCrit(15)
                        .setSkillSlot(new Skill[]{skillsList.get(8), skillsList.get(9), skillsList.get(10), skillsList.get(11)})
                        .build();

        Backpack backpack = Backpack.getInstance();
        ItemFactory itemFactory = new ItemFactory();
        backpack.getBackpack().add(itemFactory.getItemType("smallitemhp"));
        mobs.add(new Mob("Alumnus", Role.LOGIC,new Skill[]{skillsList.get(0), skillsList.get(1)} ,200,200,1,10,1f,1f,5,0, new int[]{60, 40},"/battleIcons/07b.png"));
        mobs.add(new Mob("Custode", Role.MEMORY, new Skill[]{skillsList.get(0), skillsList.get(1)},200,200,1,10,1f,1f,5,0, new int[]{60, 40},"/battleIcons/31.png"));
        mobs.add(new Mob("KSM", Role.CREATIVITY, new Skill[]{skillsList.get(0), skillsList.get(1)},200,200,1,10,1f,1f,5,0, new int[]{60, 40},"/battleIcons/01.png"));
    }
    ...
    public Mobs getBoss1() {
        ...
        skills[1] = new Skill("Skill2","è una skill",4,10,100, MalusHp.getInstance(),Role.LOGIC,1);
        Mob mob = new Mob("Boss1", Role.LOGIC, skills,1000,1000,1,10,1f,2f,5,0, new int[]{100,0},"/decBoss/BOSSISS.png");
