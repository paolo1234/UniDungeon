...
public class GameOverView extends GameView {
  ...
  public GameOverView() {
    ...
    try {
      rettore[0] =
          ImageIO.read(
              Objects.requireNonNull(getClass().getResource("/gameover/rettoreride1.png")));
      rettore[1] =
          ImageIO.read(
              Objects.requireNonNull(getClass().getResource("/gameover/rettoreride2.png")));
      rettore[2] =
          ImageIO.read(
              Objects.requireNonNull(getClass().getResource("/gameover/rettoreride3.png")));
      rettore[3] =
          ImageIO.read(
              Objects.requireNonNull(getClass().getResource("/gameover/rettoreride4.png")));
      font =
          Font.createFont(
                  Font.TRUETYPE_FONT,
