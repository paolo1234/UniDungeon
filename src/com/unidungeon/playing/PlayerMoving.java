...
public class PlayerMoving {
    ...
    private void loadSpriteRange(int startIndex, String basePath, int startNum, int count) throws IOException {
        for (int i = 0; i < count; i++) {
            String path = basePath + (startNum + i) + ".png";
            sprites[startIndex + i] = ImageIO.read(Objects.requireNonNull(getClass().getResourceAsStream(path)));
        }
    }
