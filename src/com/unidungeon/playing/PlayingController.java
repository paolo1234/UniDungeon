...
public class PlayingController implements Controller {
    ...
    public PlayingController() {
        ...
        this.view = new PlayingView(gameModel.getPlayingModel().getPlayerMoving(), gameModel.getWallet());
    ...
    public void checkTile(PlayerMoving entity){
        ...
        try {
            switch (entity.getDirection()) {
                case UP -> {
                    entityTopRow = (entityTopWorldY - entity.getSpeed()) / 48; // prediciamo dove sarà il player in che tile
