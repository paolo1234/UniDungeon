...
public class PlayingView extends GameView {
    ...
    private void drawMapTiles(Graphics2D g2) {
        ...
        while (worldCol < gameMap.getWorldCol() && worldRow < gameMap.getWorldRow()) {
            ...
            if (worldX + tileSize > player.getWorldX() - player.getScreenX() && worldX - tileSize < player.getWorldX() + player.getScreenX() &&
                    worldY + tileSize > player.getWorldY()  - player.getScreenY() && worldY - tileSize < player.getWorldY()  + player.getScreenY()) {
                Image i;
                try {
                ...
                if(tileIndex != 0)
                    g2.drawImage(i, screenX, screenY, null);
            }
            worldCol++;
    ...
    private void drawDecorations(Graphics2D g2) {
        for (Decorazioni obj: gameMap.getDecoration()) {
            ...
            if (obj.worldX + 5 * tileSize > player.getWorldX() - player.getScreenX() && obj.worldX - tileSize < player.getWorldX() + player.getScreenX() &&
                    obj.worldY + 5 * tileSize > player.getWorldY() - player.getScreenY() && obj.worldY - tileSize < player.getWorldY()+ player.getScreenY()) {
    ...
    private void drawInteractables(Graphics2D g2) {
        for (Interagibili obj: gameMap.getInteragibili()) {
            if (obj.getImage() != null){
                int screenX = obj.worldX - player.getWorldX() + player.getScreenX();
                int screenY =  obj.worldY - player.getWorldY() + player.getScreenY();
                if (obj.worldX + 4 * tileSize > player.getWorldX() - player.getScreenX() && obj.worldX - tileSize < player.getWorldX() + player.getScreenX() &&
                        obj.worldY + 4 * tileSize > player.getWorldY() - player.getScreenY() && obj.worldY - tileSize < player.getWorldY()+ player.getScreenY()) {
    ...
    public void drawPlayer(Graphics2D g2){
        if(debug) {
            ...
            g2.drawString("col: " + player.getWorldX() / tileSize + " row: " + player.getWorldY() / tileSize, 38, 11 * 48 - 24);
        }
    ...
    class PauseStrategy implements PlayingStrategy{
        ...
        public PauseStrategy(){
            try {
                ...
                pauseFont = Font.createFont(Font.TRUETYPE_FONT, Objects.requireNonNull(getClass().getResource("/fonts/AGOBLINAPPEARS.TTF")).openStream()).deriveFont(12f);
        ...
        public void draw(Graphics2D g2) {
            ...
            if(items.size() > 0 && items.get(currentPauseIndex) != null && items.get(currentPauseIndex).getImage() != null)
            ...
            if(items.size() > 0 && currentPauseIndex >= 0 && currentPauseIndex < items.size() && items.get(currentPauseIndex) != null){
                TextRenderer.drawString(
                        g2,
            ...
            if(currentPlayerIndex != -1 && players != null && currentPlayerIndex >= 0 && currentPlayerIndex < players.length && players[currentPlayerIndex] != null){
                ...
                if(currentPlayerIndex >= 0 && currentPlayerIndex < 3 && players[currentPlayerIndex].getIcon() != null){
                    ...
                    TextRenderer.drawString(
                            g2,
                            players[currentPlayerIndex].getHp() + "/" + players[currentPlayerIndex].getMaxHp() + " HP",
                            pauseFont != null ? pauseFont.deriveFont(13f) : font.deriveFont(13f),
                            Color.WHITE,
                            hp,
                            TextAlignment.MIDDLE,
                    ...
                    TextRenderer.drawString(
                            g2,
                            players[currentPlayerIndex].getSp() + "/" + players[currentPlayerIndex].getMaxSp()+ " SP",
                            pauseFont != null ? pauseFont.deriveFont(13f) : font.deriveFont(13f),
                            Color.WHITE,
                            sp,
                            TextAlignment.MIDDLE,
