...
public class GameStateTrigger extends Interagibili{
    private GameState gameState;
    private BufferedImage image;
    private Rectangle boxCollider;

    public GameStateTrigger(int worldX, int worldY, boolean solid, Rectangle boxCollider,GameState gameState){
        this.worldX = worldX;
        this.worldY = worldY;
        this.solid = solid;
    ...
    public GameStateTrigger(int worldX, int worldY, boolean solid, Rectangle boxCollider, GameState gameState, String imagePath, int width, int height){
        this.worldX = worldX;
        this.worldY = worldY;
        this.solid = solid;
        this.gameState = gameState;
    ...
    public void action(){
        ...
        gameStateMachine.setGameState(gameState);
    }
}
