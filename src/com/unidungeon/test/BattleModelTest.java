...
public class BattleModelTest extends TestCase {
  ...
  public void testPlayerAttack() {
    ...
    player[2].setKO();
    // Attacks not crit
    this.model.playerAttack(
        player,
        mobs,
        null,
        new int[] {0, 0, 4},
        new int[] {0, 0, 0},
        new Skill[] {player[0].getSlotSkill()[0], player[1].getSlotSkill()[0], null});
    ...
    this.model.playerAttack(
        ...
        new int[] {4, 4, 0},
        new int[] {0, 0, 0},
        new Skill[] {null, null, player[2].getSlotSkill()[0]});
    ...
    this.model.playerAttack(
        ...
        new int[] {0, 4, 4},
        new int[] {0, 0, 0},
        new Skill[] {player[0].getSlotSkill()[1]});
    ...
    this.model.playerAttack(
        ...
        new int[] {1, 4, 4},
        new int[] {0, 0, 0},
        new Skill[] {null, null, null});
    assertEquals(58, player[0].getSp());
    // Item
    // assertEquals(57,player[1].getSp());
    // this.model.playerAttack(player,mobs,new int[]{2,4,4}, new int[]{1,0,0}, new
