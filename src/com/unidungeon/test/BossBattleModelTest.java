...
public class BossBattleModelTest extends TestCase {
  ...
  public void testBossNervous() {
    ...
    this.model.bossNervous(
        boss,
        new int[] {0, 0, 1},
        new Skill[] {player[0].getSlotSkill()[1], player[1].getSlotSkill()[1]});
  ...
  public void testBossAttack() {
    ...
    this.model.bossNervous(
        ...
        new int[] {0, 0, 0},
        new Skill[] {
          player[0].getSlotSkill()[1], player[1].getSlotSkill()[1], player[2].getSlotSkill()[1]
        });
    this.model.bossNervous(
        boss,
        new int[] {0, 0, 1},
