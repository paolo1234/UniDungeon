...
public class MobTest extends TestCase {
    ...
    public void setUp() throws Exception {
        ...
        mob = new Mob("Alumnus", Role.LOGIC,skill,500,500,1,10,1f,1f,5,0,new int[]{20,35,45},"/battleIcons/07b.png");
    }

    public void testRandomSkill() {
        Skill skillOttenuta= mob.randomSkill();
        assertNotNull(skillOttenuta);
        assertTrue("skill1".equals(skillOttenuta.getName())||"skill2".equals(skillOttenuta.getName())||"skill3".equals(skillOttenuta.getName()));
    }
